...
import 'package:myanimelist/widgets/addSpace.dart';
import 'package:myanimelist/widgets/categoriesTitleText.dart';
                        ...
                        child: SizedBox(
                          ...
                          child: ListView.separated(
                            ...
                            separatorBuilder:
                              ...
                              return AddHorizontalSpace(width(context) * 0.01);
                            },
                          ),
                        ),
                      )
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      widget.listResponse[widget.animeIDIndex]['score'] == null
                          ? CustomText(
                              text: 'N/A', color: secondary_color, size: 18)
                          : CustomText(
                          ...
                          Expanded(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                AddVerticalSpace(height(context) * 0.01),
                                CategoryText(widget
                                    .listResponse[widget.animeIDIndex]['type']),
                              ],
                            ),
                          ),
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            widget.listResponse[widget.animeIDIndex]['rank'] ==
                                ...
                                : CategoryText(widget
                                    .listResponse[widget.animeIDIndex]['rank']
                                    .toString()),
                          ],
                        ),
                      ),
